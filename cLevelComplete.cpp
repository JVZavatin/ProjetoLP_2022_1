...
cLevelComplete::cLevelComplete() : wxFrame(nullptr, wxID_ANY, "wxLetroca - Fase concluida!", wxPoint(30, 30), wxSize(800, 600)) {

	// SIZER PRINCIPAL	
	wxBoxSizer* sizer = new wxBoxSizer(wxVERTICAL);

	wxSizer* sizer_titulo = new wxBoxSizer(wxVERTICAL);
	wxStaticText* parabens_text = new wxStaticText(this, wxID_ANY, "Parabens", wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE_HORIZONTAL | wxST_NO_AUTORESIZE | wxBORDER_SIMPLE);
	...
	btnNextGame = new wxButton(this, 10001, "Proximo level", wxPoint(10, 10), wxSize(150, 50));
